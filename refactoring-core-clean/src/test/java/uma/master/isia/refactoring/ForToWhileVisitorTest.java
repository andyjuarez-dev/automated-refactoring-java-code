...
public class ForToWhileVisitorTest {

	@Test
	void testStructural_ForWithBreakWithInitializerDefined() throws Exception {
	...
	@Test
	void testStructural_ForWithBreakWithoutInitializers() throws Exception {
	...
	@Test
	void testStructural_ForWithBreakWithoutBlock() throws Exception {
	...
	@Test
	void testStructural_ForWithBreakEmptyBlock() throws Exception {
